...
(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.wordCloudCustomSeriesInstaller = factory(global.echarts));
    ...
    var renderItem = function (params, api) {
        ...
        return {
            ...
            style: {
                ...
                fontWeight: api.visual('fontWeight') || 'normal',
                fontFamily: api.visual('fontFamily') || 'sans-serif',
                fontStyle: api.visual('fontStyle') || 'normal',
    ...
    function performLayout(params, api, payload) {
        ...
        var left = echarts.number.parsePercent(payload.left || 0, width);
        var right = echarts.number.parsePercent(payload.right || 0, width);
        var top = echarts.number.parsePercent(payload.top || 0, height);
        var bottom = echarts.number.parsePercent(payload.bottom || 0, height);
